...
@section('css')
  ...
  <style>
        @media (max-width: 768px) {
            ...
            .mobile-flex-container img.yogi-logo {
                max-width: 80px;
                margin-right: 10px;
            }

            .mobile-flex-container h1 {
                margin-bottom: 0;
                font-size: 1.2rem;
            }
...
<section class="gita-hero-sec mt-0">
  <div class="container mt-0">
    <div class="row">
      <div class="col-lg-6">
        <div class="pr-lg-5 text-center mt-0">
        ...
        <!-- Trust block for desktop view -->
        <div class="trust-block d-none d-md-block">
          <div class="row">
            <div class="col-md-6 text-center">
              <div class="avg-rating mb-2 mt-3" style="background: transparent;">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star-half-o"></i>
                <span class="d-block mt-2"><b>4.7/5</b>(4.5K Reviews)</span>
              </div>
              <a href="https://search.google.com/local/reviews?placeid=ChIJD6H5w50UrjsRpF_IYcgu7DI" target="_blank" title="Check All Reviews" rel="noopener" class="mt-1">
                <img src="{!! asset('public/assets/frontend1/images/bambinos_google_logo.png') !!}" style="height:32px;" alt="bambinos.live Reviews">
              </a>
            ...
            <div class="col-md-6 text-center">
              <div class="avg-rating mt-3" style="background: transparent;">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star-half-o"></i>
                <span class="d-block mt-2"><b>4.5/5</b>(500+ Reviews)</span>
              </div>
              <a href="https://www.trustpilot.com/review/bambinos.live" target="_blank" title="Check All Reviews" rel="noopener">
                <img src="{!! asset('public/assets/frontend1/images/trustpilot4.png') !!}" class="trustpilot-logo" alt="bambinos.live Reviews">
              </a>
              <div class="mt-1" style="color:#000;">
                <div itemscope="" itemtype="http://schema.org/Product">
                  <span itemprop="name">bambinos.live <a href="https://www.trustpilot.com/review/bambinos.live" target="_blank" title="Check All Reviews" rel="noopener"> Reviews</a></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-6">
        ...
        <!-- Trust block for mobile view -->
        <div class="trust-block d-md-none">
          <div class="row row-xs">
            <div class="col-md-6 col-6 text-center">
              ...
              <a href="https://search.google.com/local/reviews?placeid=ChIJD6H5w50UrjsRpF_IYcgu7DI" target="_blank" title="Check All Reviews" rel="noopener" class="mt-1">
                <img class="google-review-logo" src="{!! asset('public/assets/frontend1/images/bambinos_google_logo.png') !!}" style="height:32px;" alt="bambinos.live Reviews">
              </a>
            </div>
            <div class="col-md-6 col-6 text-center">
              <div class="avg-rating mt-3" style="background: transparent;">
...
<script src="//rum-static.pingdom.net/pa-66c82cff0cda420012000048.js" async></script>
@endsection
